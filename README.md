...
_Not a paper list. Not a hype list. A decision-making tool. Every entry answers: should I use this model, and how?_
...
> **Tip**: Best GGUF quantization support of any family. Q4_K_M is the recommended sweet spot for quality vs. speed.
...
| Model             | Full VRAM | Q4_K_M VRAM | Quality Loss |
| :---------------- | --------: | ----------: | :----------: |
...
| :---------- | ---------: | :--------: | :--------: | :----------------------------- |
| GGUF Q2_K   |       ~75% |    ⭐⭐    |  ⭐⭐⭐⭐  | Extreme RAM constraint only    |
| GGUF Q4_K_M |       ~55% |  ⭐⭐⭐⭐  |  ⭐⭐⭐⭐  | **Recommended default**        |
| GGUF Q5_K_M |       ~45% |  ⭐⭐⭐⭐  |   ⭐⭐⭐   | Quality-critical tasks         |
| GGUF Q8_0   |       ~20% | ⭐⭐⭐⭐⭐ |   ⭐⭐⭐   | Near-lossless                  |
...
_If this list saved you research time, star it and share it._
